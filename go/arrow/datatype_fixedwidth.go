...
func (t *BooleanType) Fingerprint() string { return typeIdFingerprint(t) }
...
func (t *FixedSizeBinaryType) Fingerprint() string {
	return fmt.Sprintf("%s[%d]", typeIdFingerprint(t), t.ByteWidth)
}
...
func (t *TimestampType) Fingerprint() string {
	return fmt.Sprintf("%s%s%d:%s", typeIdFingerprint(t), string(timeUnitFingerprint(t.Unit)), len(t.TimeZone), t.TimeZone)
}
...
func (t *Time32Type) Fingerprint() string {
	return typeIdFingerprint(t) + string(timeUnitFingerprint(t.Unit))
}
...
func (t *Float16Type) Fingerprint() string { return typeIdFingerprint(t) }
...
func (t *Decimal128Type) Fingerprint() string {
	return fmt.Sprintf("%s[%d,%d,%d]", typeIdFingerprint(t), t.BitWidth(), t.Precision, t.Scale)
}
...
func (*MonthIntervalType) Fingerprint() string {
	return typeFingerprint(INTERVAL) + "M"
}
...
func (*DayTimeIntervalType) Fingerprint() string {
	return typeFingerprint(INTERVAL) + "d"
}
